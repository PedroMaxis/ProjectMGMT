...
class TeamMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create team_member" do
    assert_difference("TeamMember.count") do
      post team_members_url, params: { team_member: { name: @team_member.name, project_id: @team_member.project_id, role: @team_member.role } }
    end
  ...
  test "should update team_member" do
    patch team_member_url(@team_member), params: { team_member: { name: @team_member.name, project_id: @team_member.project_id, role: @team_member.role } }

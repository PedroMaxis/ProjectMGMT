...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference("Milestone.count") do
      post milestones_url, params: { milestone: { description: @milestone.description, due_date: @milestone.due_date, project_id: @milestone.project_id, title: @milestone.title } }
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { description: @milestone.description, due_date: @milestone.due_date, project_id: @milestone.project_id, title: @milestone.title } }
